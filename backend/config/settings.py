...
class AppSettings(BaseSettings):
    ...
    # JWT secret — override in production via .env.
    ...
    def ALLOWED_ORIGINS(self) -> list[str]:
        ...
        if self.ENVIRONMENT == "production":
            ...
            # Always allow the known Netlify frontend.
        ...
        # Ensure the Netlify URL is also included in dev.
    ...
    # Pastas de job (arquivos/<job_id> e static/imagens/<job_id>) mais
    # antigas que isso são removidas periodicamente para não encher o disco.
    JOB_RETENTION_DAYS: int = 30
    JOB_CLEANUP_INTERVAL_HOURS: int = 24
